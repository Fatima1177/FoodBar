  ...
  <section className="bg-white min-h-screen relative flex items-center">
    <div className="container mx-auto flex flex-col-reverse md:flex-row items-center">
      <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col items-start justify-center">
        ...
        <p className="text-[#6c757d] mb-6 max-w-lg leading-relaxed">
        ...
        <button className=" bg-[#dc3545] text-white font-semibold py-3 px-6 rounded-md shadow-md transition-all duration-300 border-2 border-transparent hover:bg-[#f8f9fa] hover:text-[#dc3545] hover:border-[#dc3545] hover:shadow">
          Check Our Menu
        </button>
      ...
      <div className="w-full md:w-1/2 relative flex items-center justify-center p-8 md:p-12">
        <img src={about} alt="Cupcake" className="w-64 h-auto relative z-10"/>
      </div>
    </div>
  </section>
);
